...
var translationsEN = {
  ...
  "VIEW_MY_MEALS": {
    ...
    "NO_INCOMING_MEALS_2": "Create a meal",
    "NO_INCOMING_MEALS_3": 'or',
    "NO_INCOMING_MEALS_4": "Browse a meal",
...
var translationsFR = {
  ...
  "VIEW_MEALS": {
    ...
    "FILTERS": {
      ...
      "HELP_TYPE": {
        ...
        "HELP_COOKING_MOBILE": "Cuisine",
        "HELP_CLEANING": "Aide-nettoyage",
        "HELP_CLEANING_MOBILE": "Vaisselle",
        "SIMPLE_GUEST": "Invité",
      },
      "VALIDATE": 'Valider',
  ...
  "VIEW_MEALS_DTLD": {
    "DESCRIPTION": 'Description',
    "VEGETARIAN_MEAL": "Repas végétarien",
    "VEGAN_MEAL": "Repas vegan",
    "HALAL_MEAL": "Repas halal",
    "KOSHER_MEAL": "Reaps kasher",
    "INSCRIPTION": {
    ...
    "ACTION_BUTTON": {
      ...
      "MEAL_FULL": "Le repas est plein !",
      "SIGN_IN_1": 'Merci de',
      "SIGN_IN_2": 'se conneceter',
      "SIGN_IN_3": 'si vous êtes déjà inscrit.'
    },
    "PARTICIPANTS": {
      "AGE": "ans",
  ...
  "LOGIN": {
    ...
    "SIGN_IN": "Se connecter avec facebook"
  },
  "VIEW_MY_MEALS": {
    "INCOMING_MEALS": "Prochain repas",
    ...
    "PENDING_REQUESTS": 'Réservations en attente',
    "PRICE_FROM": "De",
    "STATUS": {
      "ATTENDING": 'J’y participe',
      "PENDING": 'En attente',
    ...
    "NO_INCOMING_MEALS_2": "Créer un repas",
    "NO_INCOMING_MEALS_3": 'ou',
    "NO_INCOMING_MEALS_4": "Chercher un repas",
