...
class TestAuthMealAPI(unittest.TestCase):
    ...
    def test_get_meal_private_info_subscribed(self):
        jsonAPIExpMeal1 = "{\"_id\": \"111111111111111111111111\",\"town\": \"Santiago\",\"admin\":{\"_id\": \"111111111111111111111111\",\"picture\": {\"data\": {\"url\": \"https://scontent.xx.fbcdn.net/v/t1.0-1/c118.328.304.304/s50x50/13876126_103197600128021_307111277992761230_n.jpg?oh=334ce0ee3ef6001a6c984fb21531d364&oe=58568A30\",\"is_silhouette\": false}},\"first_name\": \"Jennifer\",\"last_name\": \"TestosUser\",\"gender\": \"female\"},\"menu\": \"Jolie piece de boeuf\",\"price\": 100,\"detailedInfo\": {\"requiredGuests\": {\"cooks\":{\"nbRquCooks\":3,\"nbRemainingPlaces\":2,\"timeCooking\":\"2016-07-13T18:00:39.303Z\",\"price\":10},\"cleaners\":{\"nbRquCleaners\":1,\"nbRemainingPlaces\":1,\"price\":10},\"simpleGuests\":{\"nbRquSimpleGuests\":6,\"nbRemainingPlaces\":6,\"price\":10}}},\"nbGuests\": 10,\"nbRemainingPlaces\": 9,\"veggies\": false,\"time\": \"2016-11-20T17:00:00.000Z\",\"addressApprox\": \"Métro Anvers L2\",\"privateInfo\": {\"address\": \"30 avenue de Trudaine 75009\",\"adminPhone\":\"0601020304\",\"users\": [{\"_id\": \"111111111111111111111111\",\"role\": [\"admin\", \"cook\"]}]}}"
        resp = self.client.get("/api/meal/111111111111111111111111/private",headers = {'Authorization': 'Bearer {0}'.format(self.adminUser.token())})
        self.assertEqual("200 OK", resp.status)
        resp = json.loads(resp.data)
        expected = json.loads(jsonAPIExpMeal1)
        self.assertEquals(resp,expected)
